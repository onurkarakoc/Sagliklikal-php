			...
			<div id="portfolio-images" class="clearfix">
				...
				<div class="col">
					<div class="portfolio-item">
						...
						<a href="../foods/haslanmisyumurta.php">
							<img class="img-fluid" src="/images/yumurta.png" alt="yumurta">
				...
				<div class="col">
					<div class="portfolio-item">
						...
						<a href="../foods/ananas.php">
							<img class="img-fluid" src="/images/ananas.jpg" alt="ananas">
				...
				<div class="col">
					<div class="portfolio-item">
						...
						<a href="../foods/mevsimsalata.php">
							<img class="img-fluid" src="/images/salata.jpg" alt="salata">
				...
				<div class="col">
					<div class="portfolio-item">
						...
						<a href="../foods/mercimekcarbasi.php">
							<img class="img-fluid" src="/images/mercimekcorbasi.jpg" alt="mercimekçorbası">
				...
				<div class="col">
					<div class="portfolio-item">
						...
						<a href="../foods/izgaratavuk.php">
							<img class="img-fluid" src="/images/tavukizgara.jpg" alt="tavukızgara">
