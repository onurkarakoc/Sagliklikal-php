	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="mercimekçorbası.Jpeg" alt="mercimekçorbası" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Mercimek Çorbası </p>
            <p class="left"> Birim:1 porsiyon(orta) 300 gr  </p>
            <br/>
            <p class="left"> Kalori Miktarı: 137 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:17.125%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Mercimek çorbası protein oranı yüksek ve besleyici bir çorbadır.Diyabetikler için ve vejeteryanlar için çok uygun bir öğündür.</p>
        </div>
