	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="mercimekyemeği.jpg" alt="mercimekyemeği" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Mercimek Yemeği </p>
            <p class="left"> Birim: 1 Porsiyon (Orta) 230 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 164 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:20.5%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Diyet sırasında mercimek tüketmek uzun süre tok kalmamıza yardım edecektir. Mercimeğin lifli yapısı sindirim sisteminizin daha hızlı çalışmasına yardım edecektir.</p>
        </div>
