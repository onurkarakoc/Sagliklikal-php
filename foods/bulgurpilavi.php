	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="bulgurpilavı.jpg" alt="bulgurpilavı" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Bulgur Pilavı </p>
            <p class="left"> 1 porsiyon(orta) 130 gr  </p>
            <br/>
            <p class="left"> Kalori Miktarı: 150 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:18.75%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Bulgurun içerdiği lif uzun süre tok kalmamızı sağlıyor. Sindirim ve bağışıklık sistemlerinin sağlığını koruyor ve metabolizmamızı hızlandırarak kilo verme sürecimizi destekliyor.Yemekte bulgur pilavı tüketeceksek yanında ekmek yememeliyiz.Eğer bir ana yemeğimiz varsa, yanında 4-5 yemek kaşığı bulgur pilavı yeterli olacaktır. Sadece bulgur pilavı ve cacık varsa, büyük bir kase dolusu cacık ve 7-8 yemek kaşığı da bulgur pilavı yenebilir.</p>
        </div>
