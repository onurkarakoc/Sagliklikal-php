	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="telkadayıf.jpg" alt="telkadayıf" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Tel Kadayıf </p>
            <p class="left"> Birim: 1 porsiyon(orta) 160 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 440 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:55%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Kilo kontrolü ve diyet yapan kişiler özellikle kalori hesabı yaparak diyet gerçekleştiriyorsa kadayıftan uzak durmalıdır.Kalori bakımından oldukça yüksektir.</p>
        </div>
