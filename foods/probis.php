	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="probis.jpg" alt="probis" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Probis </p>
            <p class="left"> Birim: 1 paket 28 gr  </p>
            <br/>
            <p class="left"> Kalori Miktarı: 134 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:16.75%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">>Ülker probis kakaolu ve muzlu proteinli bisküvi yüksek kalorili ve şeker içeriği yüksek bir besindir. Bu nedenle çok sık tercih edilmemelidir.</p>
        </div>
