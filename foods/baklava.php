	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="baklava.jpg" alt="baklava" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Baklava </p>
            <p class="left"> 1 adet(orta) 45 gr  </p>
            <br/>
            <p class="left"> Kalori Miktarı: 129 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:16.125%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Kilo kontrolü yapanlar ve şeker hastaları sık tüketmemelidir.</p>
        </div>
