	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="elma.jpg" alt="elma" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Kirmizi Elma </p>
            <p class="left"> 1 adet(orta) 100 gr </p>
            <br/>
            <p class="left"> 52 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:16.375%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Kırmızı elma:Birçok vitamin ve mineral madde içerir. A, B1, B2, C, E vitaminleri ile magnezyum, potasyum, fosfor gibi mineral maddeler bulundurur. Büyük bir elma yemekle günlük alınması gereken lif miktarının % 30′unu almış olursunuz..</p>
        </div>
