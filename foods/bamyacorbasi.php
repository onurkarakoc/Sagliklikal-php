	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="bamyaçorbası.jpg" alt="bamyacorbası" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Bamya Çorbası </p>
            <p class="left"> 1 porsiyon(orta) 270 gr  </p>
            <br/>
            <p class="left"> Kalori Miktarı: 45 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:5.625%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Bamya C, K, B vitaminleri mangan ve magnezyum mineralleri açısından iyi bir besin kaynağıdır. Sahip olduğu yüksek lif, vitamin, ve mineraller sayesinde kilo kontrolünde ve kolesterolde etkilidir. Diyet yemeklerinde kullanılacağı gibi sağlıklı yaşam için tüketilmesi gerekli bir besindir.</p>
        </div>
