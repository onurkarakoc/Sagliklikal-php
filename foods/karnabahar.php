	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="karnabahar.jpg" alt="karnabahar" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Karnabahar </p>
            <p class="left"> Birim: 1 porsiyon(orta) 150 gr</p>
            <br/>
            <p class="left"> Kalori Miktarı: 38 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:4.75%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Çok iyi bir lif kaynağı olduğu için midede hacim kaplar ve daha çabuk doygunluk oluşturur. Özellikle sofraya oturduğunuzda ilk yemek olarak karnabahar salatası veya fırında karnabahar veya haşlanmış karnabahar olarak tercih ederseniz asıl kalorili olan ana yemeği daha az yersiniz.</p>
        </div>
