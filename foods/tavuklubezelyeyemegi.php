	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="tavuklubezelyeyemeği.jpg" alt="tavuklubezelyeyemeği" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Tavuklu Bezelye Yemeği </p>
            <p class="left"> Birim: 1 porsiyon(orta) 130 gr  </p>
            <br/>
            <p class="left"> Kalori Miktarı: 92 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:3.5%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Düşük kalorili ürünler arasında bulunan 92 kalorili 1 porsiyon tavuklu bezelye gıdasını diyet yaparken tüketebilirsiniz.</p>
        </div>
