	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="iskender.jpg" alt="iskender" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">İskender </p>
            <p class="left"> Birim: 1 porsiyon(orta) 500 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 755 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:94.375%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Yüksek kalorisi nedeniyle porsiyon kontrolüne dikkat etmek gerekir.Sık tüketilmemelidir.</p>
        </div>
