	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="ananas.jpg" alt="ananas" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Ananas </p>
            <p class="left"> Birim: 1 dilim(orta) 90 gr </p>
            <br/>
            ...
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Ananas yüksek vitamin, mineral ve lif içermesinden dolayı faydalıdır.Yağ depolanmasını önleyerek selülit oluşumunu engeller.</p>
        </div>
