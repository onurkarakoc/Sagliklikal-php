	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="haşlanmışyumurta.Jpeg" alt="haşlanmışyumurta" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Haşlanmış Yumurta </p>
            <p class="left"> 1 adet(orta) 50 gr  </p>
            <br/>
            <p class="left"> Kalori Miktarı: 75 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:9.375%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Protein içeriği yüksek olan yumurta gibi besinlerin tüketimi sayesinde doygunluk hissi artıyor ve tokluk süresi uzuyor. Bu nedenle kilo kontrolü açısından da yumurta tüketimi beslenmede önemli bir yer tutuyor.Yumurta ayrıca A, D, B1, B2, B6, B12, E ve K vitaminleri kaynağıdır. Lutein, sistein, kalsiyum, magnezyum, demir, kolin, folik asit ve çinko içerir.Kas yapımını sağlar ve yağ yakımında etkilidir.</p>
        </div>
