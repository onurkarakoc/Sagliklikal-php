	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="salatalık.jpg" alt="salatalık" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Salatalık </p>
            <p class="left"> Birim: 1 adet(orta) 120 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 14 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:1.75%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Salatalık içerdiği su yoğunluğu sayesinde çok düşük kaloriye sahiptir bu nedenle salatalığı diyette gönül rahatlığı ile tüketebilirsiniz.</p>
        </div>
