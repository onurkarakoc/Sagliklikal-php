...
<body>
	...
	<header>
      ...
      <div class="middle-box"id="searchbox">
        <input type="text" placeholder="Kac kalori..." id="search">
				<a href="#"><i style="color:white;"  class="fa fa-search"></i></a>
      </div>
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="ızgaraköfte.jpg" alt="ızgaraköfte" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Izgara Köfte </p>
            <p class="left"> Birim: 1 porsiyon(orta) 120 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 200 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:25%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Diyet süresince tüketilecek köftelerin mutlaka ızgarada pişirilmesi gerekir. Köftenin büyüklüğü kalorisini etkileyeceğinden, porsiyonlar abartılmamalıdır. Köfte harçlarında yüksek kalorili ürünlerden kaçınılmalıdır.</p>
        </div>
