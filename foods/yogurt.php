	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="yoğurt.jpg" alt="yogurt" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Yoğurt </p>
            <p class="left"> Birim: 1 yemek kaşığı 45 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 28 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:3.5%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Yoğurt:Hem düşük kalorili hem de besleyici olmasıyla zayıflamaya yardımcı oluyor; içinde bulundurduğu karbonhidrat, protein ve yağa ek olarak kalsiyum açısından da çok zengin olması sebebiyle sağlıklı bir şekilde kilo vermenize yardımcı oluyor.İçerdiği kalsiyum ve aminoasitler sayesinde vücuttaki yağları yakar, toksinleri dışarı atar. Kasların güçlenmesini sağlar.</p>
        </div>
