	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="nar.jpg" alt="nar" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Nar </p>
            <p class="left"> Birim: 1 adet(orta) 160 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 133 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:66.625%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Yaz aylarının vazgeçilmez meyvesi nar, inanılmaz bir C vitamini deposudur. Ayrıca E ve K vitaminleri içerir. Muz ve kivi gibi mineral açısından oldukça zengindir. Kalsiyum, magnezyum, selenyum, potasyum, sodyum, demir, bakır ve çinko içerdiği madensel tuzlardır.Narın faydalarına bakacak olursak, nar özünde şeker ve katkı maddesi içermez. Bu nedenle çeşitli diyetlerde tercih edilen bir meyvedir.</p>
        </div>
