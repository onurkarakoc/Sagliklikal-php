	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="yeşilçay.jpg" alt="yesilcay" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Yeşil Çay </p>
            <p class="left"> Birim: 1 fincan </p>
            <br/>
            <p class="left"> Kalori Miktarı: 0 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:0%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Yeşil çayın faydalarından biri de metabolizmayı hızlandırarak yağ yakmaya yardımcı olmasıdır. Yeşil çaydaki kateşinler vücudun termojeneze girmesini sağlar. Bu süreç de o fazla kilolardan enerji üretir.Aynı zamanda hafif bir iştah bastırıcıdır. Daha az yemenizi ve atıştırmalıklar tüketmeden bir öğünden diğerine geçmenizi sağlar.</p>
        </div>
