	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="madensuyu.jpg" alt="madensuyu" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Maden Suyu </p>
            <p class="left"> Birim: 1 şişe </p>
            <br/>
            ...
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Maden suyu, metabolizmanızın daha hızlı çalışmasına yardımcı olur. Günlük hayatta gazlı içecekler yerine maden suyu tercih edebilirsiniz.</p>
        </div>
