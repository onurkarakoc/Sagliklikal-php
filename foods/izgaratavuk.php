	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="ızgaratavuk.jpg" alt="ızgaratavuk" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Izgara Tavuk </p>
            <p class="left"> Birim: 1 porsiyon(orta) 250 gr  </p>
            <br/>
            <p class="left"> Kalori Miktarı: 274 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:34.25%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Haşlama ve ızgara yapılarak pişirilen tavuk etinin sindirimi, yağda kızarmış haline nazaran daha kolaydır.Haşladığınız veya ızgara yaptığınız tavukları salatalarınızın üzerine koyarak yeni ve değişik lezzetler oluşturabilirsiniz.Tavuk eti özellikle diyet yapanlar için az kalorili, alternatif bir öğündür.</p>
        </div>
