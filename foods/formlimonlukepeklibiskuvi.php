	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="formlimonlukepeklibisküvi.jpg" alt="formlimonlukepeklibisküvi" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Fırın Limonlu Kepekli Bisküvi </p>
            <p class="left"> 1 paket 50 gr  </p>
            <br/>
            <p class="left"> Kalori Miktarı: 196 kcal</p>
            <br/>
            <div id="bar"><div id="progress" style="width:24.5%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Ara öğünlerde ya da açlığı bastırmak adına kullanılabilir.</p>
        </div>
