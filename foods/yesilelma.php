	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="yeşilelma.gif" alt="yesilelma" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Yeşil Elma </p>
            <p class="left"> Birim: 1 adet(büyük) 150 gr  </p>
            <br/>
            <p class="left"> Kalori Miktarı: 78 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:9.75%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Yeşil elma, vitamin ve mineral deposu harika bir meyvedir. Yeşil elmanın bir diğer özelliği de düşük kalorisi, yüksek lifli yapısıyla zayıflamaya yardımcı olmasıdır.</p>
        </div>
