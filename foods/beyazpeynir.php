	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="beyazpeynir.jpg" alt="beyazpeynir" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Beyaz Peynir </p>
            <p class="left"> 1 dilim (orta) 30 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 93 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:3.5%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Beyaz peynir enerji değeri yüksek ve protein, kalsiyum ve B2 vitamini yönünden zengin bir besindir. Tüketirken ilk dikkat edilmesi gereken şey peynir çeşidinin içinde bulunan yağ ve tuz oranıdır.</p>
        </div>
