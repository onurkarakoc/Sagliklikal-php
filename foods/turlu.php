	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="türlü.jpg" alt="türlü" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Türlü </p>
            <p class="left"> Birim: 1 porsiyon(orta) 275 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 143 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:17.875%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Türlü, içerisinde çeşitli sebzeleri barındırdığından hem vitamin mineraller hem de posa yönünden oldukça zengin bir yemektir.</p>
        </div>
