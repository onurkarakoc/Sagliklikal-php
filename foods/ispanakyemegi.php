	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="ıspanakyemeği.jpg" alt="ıspanakyemeği" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Ispanak Yemeği </p>
            <p class="left"> Birim: 1 porsiyon(orta) 175 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 133 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:16.625%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Ispanak kalori bakımından düşük olmakla beraber diyette tercih etmeniz gereken sebzelerden biridir. Lif bakımından zengin içeriği ile sindirim sisteminizi kolaylaştırır ve bu sayede metabolizma hızını arttırır. Demir ve mineraller bakımından oldukça zengin bir içeriğe sahip ıspanak pek çok hastalığa da iyi gelir.</p>
        </div>
