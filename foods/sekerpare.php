	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="şekerpare.jpg" alt="sekerpare" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Şekerpare </p>
            <p class="left"> Birim: 1 adet(orta) 40 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 113 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:20%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Şeker hastalarının ve kilo kontrolü sağlamaya çalışan kişilerin tüketmemeye özen göstermesi gerekir.</p>
        </div>
