	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="karnıyarık.jpg" alt="karnıyarık" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Karnıyarık </p>
            <p class="left"> Birim: 1 porsiyon(orta)  345 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 191 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:23.875%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Karnıyarık; folik asit, potasyum, lif ve protein açısından zengindir.</p>
        </div>
