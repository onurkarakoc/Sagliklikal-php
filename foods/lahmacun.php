	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="lahmacun.jpg" alt="lahmacun" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Lahmacun </p>
            <p class="left"> Birim: 1 adet(orta) 120 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 177  kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:22.125%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Lahmacunu tüketirken çok yağlı olmamasına, hamurunun olabildiğince ince açılmış olmasına dikkat etmelisiniz.</p>
        </div>
