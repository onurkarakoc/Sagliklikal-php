	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="kurufasülye.jpg" alt="kurufasülye" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Kuru Fasülye(etsiz) </p>
            <p class="left"> Birim: 1 porsiyon(orta)  275 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 267 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:33.375%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Baklagillerden olan kuru fasulye tam anlamı ile bir protein deposudur. İçerdiği hayvansal olmayan protein ve lifli yapısı ile kırmızı etten bir eksiği bulunmadığı için kuru fasulye vejetaryen beslenme için de iyi bir alternatif yiyecektir.</p>
        </div>
