	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="fırınmakarna.jpg" alt="fırınmakarna" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Fırın Makarna </p>
            <p class="left"> 1 dilim(orta) 230 gr  </p>
            <br/>
            <p class="left"> Kalori Miktarı: 382 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:47.75%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Yağ içeriği yüksek bir yemektir. Porsiyon olarak diyet yapanlara tavsiye edilmez.İnce bir dilim tüketilmesi yeterli olacaktır.</p>
        </div>
