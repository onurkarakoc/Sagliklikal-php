	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="formkepeklibisküvi.jpg" alt="formkepeklibisküvi" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Form Kepekli Bisküvi </p>
            <p class="left"> 1 paket 45 gr  </p>
            <br/>
            <p class="left"> Kalori Miktarı: 184 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:23%"></div></div>
            </div>
            </div>
