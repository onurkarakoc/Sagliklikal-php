	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="mevsimsalata.jpg" alt="mevsimsalata" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Mevsim Salata </p>
            <p class="left"> Birim: 1 kase(orta) 190 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 60 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:7.5%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Salata tüketimi kişinin iştahını kontrol etmeye ve öğünlerde porsiyonlarını küçültebilmesine yardımcı oluyor.Mevsimine göre sebzeler kullanılarak hazırlanan salata günlük lif alımını artırarak kabızlık problemini çözmeye, karaciğer toksinlerinin atılımını sağlamada etkilidir.</p>
        </div>
