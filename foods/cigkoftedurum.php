	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="çiğköftedürüm.jpg" alt="çiğköftedürüm" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Çiğ Köfte Dürüm </p>
            <p class="left"> 1 Porsiyon (Orta) 150 gr  </p>
            <br/>
            <p class="left"> Kalori Miktarı: 361 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:45.125%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">İçerisindeki bulgur ve lavaş ekmek dolayısıyla karbonhidrat içeriği yüksektir.</p>
        </div>
