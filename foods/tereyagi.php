	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="tereyağı.jpg" alt="tereyagı" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Tereyağı </p>
            <p class="left"> Birim: 1 tatlı kaşığı 5 gr </p>
            <br/>
            ...
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Tereyağı özellikle karbonhidrat, yani ekmek gibi besinlerle aşırı derecede tüketilirse kilo aldırmaktadır. Bunun yanında yemeklere çok az miktarda tat vermesi için kullanılmasının fazla bir zararı yoktur.</p>
        </div>
