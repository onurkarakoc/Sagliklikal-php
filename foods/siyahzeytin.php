	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="siyahzeytin.jpg" alt="siyahzeytin" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Siyah Zeytin </p>
            <p class="left"> Birim: 7 adet(orta) 28 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı:32 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:20%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Siyah zeytin, yağ, folik asit ve lif açısından zengindir. Tuz içeriği fazla olduğundan tuz kısıtlaması olanlar tuzsuz zeytin tercih etmelidir.</p>
        </div>
