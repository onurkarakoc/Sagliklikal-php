	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="kola.jpg" alt="kola" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Kola</p>
            <p class="left"> Birim: 1 su bardağı 200 gr </p>
            <br/>
            <p class="left"> Kalori Miktarı: 122 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:15.25%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Kan şekerini yükselten kola, vücudun yağ depolama mekanizmasını harekete geçirir.Kolanın içeriğindeki asitli yapı, mide duvarını tahriş ederek mide rahatsızlıklarına yol açmaktadır. Ayrıca mide hazımsızlığına da neden olabilmektedir.Tüketilmemesi önerilmektedir.</p>
        </div>
