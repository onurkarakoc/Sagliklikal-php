	...
	<input type='submit' name="ara" value='Ara' id="submit"></i>	
      ...
      <div class="middle-box">
        <div class="col" id="col-1">
          <img src="margarin.jpg" alt="margarin" width="200px" height="200px">
          </div>
          <div class="col" id="col-2">
            <p class="center" id="font-type-col2">Margarin </p>
            <p class="left"> Birim: 1 yemek kaşığı 14 gr</p>
            <br/>
            <p class="left"> Kalori Miktarı: 99 kcal </p>
            <br/>
            <div id="bar"><div id="progress" style="width:12.375%"></div></div>
            </div>
            </div>
            <div class="middle-box" id="description">
              <p class="left" style="font-size:20px">Margarinler; ayçiçek yağı, soya, pamuk, haşhaş ve benzeri doymamış yağ asitlerinin oluşturduğu yağlara, hidrojen yüklemesi yapılarak doymuş yağ şekli verilerek elde ediliyor. Bileşenleri genellikle yağ, yağı alınmış süt, tuz ve A vitamini olarak sıralanıyor. Görünüm olarak tereyağı gibi sert kıvamda olsa da margarinin besin kalitesi daha düşük oluyor.</p>
        </div>
