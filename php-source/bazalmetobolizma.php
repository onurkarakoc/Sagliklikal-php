				...
				<div class="compute-box">
					<ul>
						<li class="compute-col">
							<p>Yaşamın sürdürülmesi ve organların işlevlerini yerine getirmesi için gerçekleşen biyokimyasal işlevlerin bütününe metabolizma denir. Bazal metabolizma hızı (BMH) ise vücudun dinlenme halindeyken kullandığı enerjidir.</p>
						</li>

						<li class="compute-col">
							<?php include('errors.php'); ?>
							<form action="bazalmetobolizma.php" method="GET">
						...
						<br><br>
						<li>
							<label>Bazal Metobolizma Hızınız:</label>
							<label><?php echo $bazal_metobolizma_hizi; ?></label>
						</li>
